        ...
        <main>
            <section className='px-8'>
                <div className="flex items-center gap-4 mb-6">
                    <h1 className='text-2xl order-1 text-right'>Hi, my name is <span className='text-blue-500'>David</span>.</h1>
                    <img src={memoji} className='w-24'/>
                </div>
                <h1 className='text-2xl mb-6'>I'm a <span className='text-blue-500'>UX Designer</span> and <span className='text-blue-500'>Researcher</span>.</h1>
                <h1 className='text-xl text-center'>And I design to help people lead <span className='text-blue-500'>healthy </span>lives and have <span className='text-blue-500'>fun</span> along the way.</h1>
            ...
            <section className='px-8 pt-6 pb-6'>
                ...
                <ul className='flex flex-col gap-6'>
                    <li>
                        <img src={mclResearchPreview} className='w-80 mx-auto'/>
                    </li>
                    <li>
                        <img src={mclDsPreview} className='w-80 mx-auto'/>
                    </li>
                    <li>
                        <img src={budderPreview} className='w-80 mx-auto'/>
                    </li>
                </ul>
            </section>
        </main>
